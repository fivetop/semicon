# KV260 LED Blink Project - Block Design Creation Script  
# Creates Block Design with Zynq PS and LED module integration
# Usage: vivado -mode batch -source create_block_design.tcl -tclargs [output_dir]
...
# Create reset port and connect to PS  
create_bd_port -dir O -type rst resetn
connect_bd_net [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_ports resetn]
...
connect_bd_net [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins led_blink_0/resetn]
...
puts "========================================"
puts "Block Design creation completed!"
puts "========================================"
puts "Block Design: design_1"
puts "Wrapper: design_1_wrapper.v"
puts "Next step: Run synthesis or implementation"
puts "========================================"
