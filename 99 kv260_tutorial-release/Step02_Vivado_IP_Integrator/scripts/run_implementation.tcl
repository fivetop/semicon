...
open_checkpoint $project_dir/$project_name.runs/impl_1/platform_wrapper_routed.dcp
write_bitstream -force $project_dir/$project_name.runs/impl_1/platform_wrapper.bit
...
set bit_src "$project_dir/$project_name.runs/impl_1/platform_wrapper.bit"
set bit_dst "$pynq_dir/platform_wrapper.bit"
set hwh_src "$project_dir/$project_name.gen/sources_1/bd/system/hw_handoff/system.hwh"
set hwh_dst "$pynq_dir/system_wrapper.hwh"
